...
---
### :+1: **Skills** :+1:
[![My Skills](https://skillicons.dev/icons?i=aws,ansible,redhat,linux,bash,docker,git,github,githubactions,graphql,md,regex,vscode,js,py,anaconda,postman,obsidian,cloudflare,grafana&perline=10)](https://skillicons.dev)
